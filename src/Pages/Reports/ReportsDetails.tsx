      ...
      <Grid container spacing={1}>
        ...
        <Grid item md={6}>
          ...
          >
            ...
            {DynamicFn(
              "Broken Tiles",
              ReportData?.roofing_proposal?.broken_tiles
            )}
            {DynamicFn(
              "Carbon Detectors",
              ReportData?.roofing_proposal?.carbon_detectors
            ...
            {DynamicFn(
              "Fascia Feet",
              ReportData?.roofing_proposal?.fascia_feet
            )}
            {DynamicFn(
              "Fascia  Cost",
            ...
            {DynamicFn(
              "Pitch Degree",
              ReportData?.roofing_proposal?.pitch_degree
            )}
            {DynamicFn(
              "plan_broken_tiles",
            ...
            {DynamicFn(
              "plan layers",
              ReportData?.roofing_proposal?.plan_layers
            )}
            {DynamicFn(
              "plan material",
            ...
            {DynamicFn(
              "plan_squares",
              ReportData?.roofing_proposal?.plan_squares
            )}
            {DynamicFn(
              "plan steep squares",
            ...
            {DynamicFn(
              "rafter feet",
              ReportData?.roofing_proposal?.rafter_feet
            )}
            {DynamicFn(
              "redecking cost",
